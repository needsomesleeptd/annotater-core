...
type DocumentService struct {
	...
	docMetaRepo   repository.IDocumentMetaDataRepository
	reportRepo    repository.IReportDataRepository
	docRepo       repository.IDocumentDataRepository
	reportService report_creator_serv.IReportCreatorService
}

func NewDocumentService(loggerSrc *logrus.Logger, docMetaRepoSrc repository.IDocumentMetaDataRepository, docRepoSrc repository.IDocumentDataRepository, reportRepoSrc repository.IReportDataRepository, reportServSrc report_creator_serv.IReportCreatorService) IDocumentService {
